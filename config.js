/* =====================================================================
   ...
   setelah memperbarui index.html atau input.html.

   Isi kedua nilai di bawah dari:
     Supabase > Project Settings > API Keys > tab "Publishable and secret"
   ...
   Nama prodi dan institusi diambil otomatis dari data.json, jadi tidak
   perlu diisi di sini.
   ===================================================================== */
